...
import {CommonTokenStream, ErrorListener, InputStream, ParseTreeWalker} from "antlr4";

var ErrorListenerQ = function(errors) {
...
export const QASMImport = function QASMImport(circuit, input, errorCallback, compatibilityMode) {
	var chars = new InputStream(input);
	var lexer = new QASMLexer(chars);
